...
pathSave = os.path.abspath('Data/data3Boolean.csv')
...
Result['Test'] = ['Dim0 AS:','Dim0 F1:','Dim0 RE:','Dim1 AS:','Dim1 F1:','Dim1 RE:',
                    'Dim2 AS:','Dim2 F1:','Dim2 RE:','Dim3 AS:','Dim3 F1:','Dim3 RE:','Dim4 AS:','Dim4 F1:','Dim4 RE:']
...
Result.to_csv(os.path.abspath('Results/Boolean_Results.csv'))
timeDF.to_csv(os.path.abspath('Results/Boolean_ResultsTiming.csv'))
